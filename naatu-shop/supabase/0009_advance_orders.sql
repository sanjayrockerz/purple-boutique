...
begin
  ...
  values(v_order_id,v_advance.product_name,v_advance.category,1,'piece',v_advance.total_amount,v_advance.total_amount,true,'advance_order',v_advance.description);
  insert into public.advance_order_payments(advance_order_id,payment_type,amount,payment_method,remarks,received_by,received_at)
