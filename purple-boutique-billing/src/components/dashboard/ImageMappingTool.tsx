...
const LS_KEY = 'purple-boutique-image-mappings'
    ...
    <div className="space-y-4">
                    ...
                    <button
                      ...
                      className={[
                        ...
                        isSelected
                          ...
                          : isMapped
                          ? 'border-emerald-400'
                          : 'border-[#D1FAE5]/40 hover:border-[#10B981]',
                      ].join(' ')}
                    >
                      {/* Image */}
          ...
          <div className="bg-white rounded-2xl border border-[#D1FAE5]/30 shadow-sm flex flex-col">
            {selectedImage ? (
              <>
                ...
                <div className="p-4 border-b border-[#D1FAE5]/20">
                  <div className="flex items-start gap-3">
                    <div className="h-20 w-20 shrink-0 rounded-xl overflow-hidden bg-[#F0F2EE] border border-[#D1FAE5]/40">
                      <img
                    ...
                    return (
                      <div className="rounded-xl bg-[#F7F8F5] border border-[#D1FAE5]/40 p-3 flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] text-[#374151]">{prod.category} · RM{prod.price}</p>
                          {prod.hasVariants && (
                ...
                {/* Map button */}
                <div className="p-4 border-t border-[#D1FAE5]/20 flex gap-2">
                  <button
                    type="button"
      ...
      {uploadResults.length > 0 && !uploading && (
        <div className="bg-white rounded-2xl border border-[#D1FAE5]/30 shadow-sm">
          ...
          <div className="max-h-[300px] overflow-y-auto divide-y divide-[#D1FAE5]/20">
