    ...
    <div className="relative min-h-screen overflow-hidden bg-[#F9FAFB] px-4 py-8 font-sans text-[#111111] sm:px-6 lg:flex lg:items-center lg:justify-center">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-[#A7F3D0] bg-white shadow-[0_24px_80px_rgba(44,57,42,0.14)] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="hidden flex-col justify-between bg-[#111111] p-10 text-white lg:flex">
          <div>
            <div className="mb-8 flex h-16 w-36 items-center justify-center rounded-2xl bg-white border border-emerald-900/40 p-2 shadow-xl overflow-hidden"><img src={BRAND_LOGO} alt={`${BRAND_EN} logo`} className="h-full w-full object-contain" /></div>
        ...
        <div className="mb-8 flex flex-col items-center text-center lg:items-start lg:text-left">
          <div className="mb-5 flex h-16 w-36 items-center justify-center rounded-2xl bg-white border border-emerald-900/40 p-2 shadow-xl overflow-hidden lg:hidden"><img src={BRAND_LOGO} alt={`${BRAND_EN} logo`} className="h-full w-full object-contain" /></div>
